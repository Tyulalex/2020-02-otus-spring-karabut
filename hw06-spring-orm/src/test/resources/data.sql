...
insert into COMMENTS (id, `comment`, `author`, book_id) values (COMMENT_SEQ_ID.nextval, 'good book', 'Jack Black', 1);
insert into COMMENTS (id, `comment`, `author`, book_id) values (COMMENT_SEQ_ID.nextval, 'bad book', 'Jack White', 1);